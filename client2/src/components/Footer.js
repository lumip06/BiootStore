...
function Footer() {
    return (
        <footer id="footer-areas " className="bg-dark">
                                    ...
                                    <div className="col-6">
                                        <div className="address-wrapper">
                                            ...
                                            <address className="mb-3 fs-7 text-light opacity-75">
                                                ...
                                                SWEET HOME Alabama, 26323
                                            </address>
                                            <p className="m-0">
                                                <a className="fs-7 link-light link-opacity-75 link-opacity-100-hover text-decoration-none"
                ...
                <div className="container border-top border-dark py-3 py-md-5 py-xl-8 py-xxl-10">
                    <div className="row gy-3 align-items-lg-center">
                        <div className="col-12 col-lg-6 order-1 order-lg-0">
                            <div
                                className="copyright-wrapper d-block mb-1 fs-7 text-light opacity-75 text-center text-lg-start">
                                &copy; 2024. All Rights Reserved.
                            </div>
                            <div
                                className="credit-wrapper d-block fs-9 text-light opacity-75 text-center text-lg-start">
