        ...
        <div className="container-fluid">
            <div id="viewChanger" style={{display: 'flex'}}>
                ...
                <div style={{justifyContent: 'flex-end', padding: '15px'}}>
                    <button id="buttonCard" className="btn btn-outline-dark" disabled={"Card"===viewType}
                            onClick={changeView}>CardView
                    </button>
                    <button id="buttonList" className="btn btn-outline-dark" disabled={"List"===viewType}
